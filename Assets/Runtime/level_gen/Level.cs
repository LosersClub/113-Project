...
public abstract class Level : MonoBehaviour  {
  ...
  private void LoadActiveRoom() {
    ...
    this.LevelManager.RightWall.SetActive(true); //TODO: write a deactivate when all are kill
  ...
  private IEnumerator EnterRoom() {
    ...
    // TODO: Spawn enemies Coroutine
    // TODO: Level Blockers Coroutine (start player enter at same time?)
    // TODO: Call ExitRoom enemies are kill
  }
...
public class GenericPool {
  ...
  private ObjectPool<GenericItem> pool;

  public void Init(GameObject parent) {
    this.pool = new ObjectPool<GenericItem>(this.prefab, this.capacity, parent: parent.transform);
  }

  public GameObject Pop() {
    return this.pool.Pop().instance;
  }
